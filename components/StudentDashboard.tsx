...
export const StudentDashboard: React.FC<Props> = ({ user, dailyStudySeconds, onSubjectSelect, onRedeemSuccess, settings, onStartWeeklyTest, activeTab, onTabChange, setFullScreen, onNavigate }) => {
  ...
  const renderMainContent = () => {
      // 1. HOME TAB
      if (activeTab === 'HOME' || activeTab === 'VIDEO') { // Defaulting 'VIDEO' to Home for now until strict type check
          return (
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 shadow-lg z-40 pb-safe">
